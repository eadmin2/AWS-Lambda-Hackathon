  ...
  if (fileType === 'image') {
    return (
      <div className="flex flex-col items-center">
        <img src={signedUrl} alt={document.file_name} className="max-w-full max-h-[70vh] rounded shadow" />
  ...
  if (fileType === 'text') {
    return (
      <div className="w-[60vw] max-w-2xl max-h-[60vh] overflow-auto bg-gray-50 p-4 rounded shadow border">
        <pre className="whitespace-pre-wrap text-sm text-gray-800">{textContent ?? 'Loading...'}</pre>
