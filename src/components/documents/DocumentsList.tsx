  ...
  return (
    <div className="space-y-6">
      {documents.map((document) => {
        ...
        const combinedRating = documentEstimates.length > 0 
            ...
            <CardContent>
              {documentEstimates.length > 0 ? (
                <div>
                  <div className="mb-4">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="text-sm font-medium text-gray-700">Combined VA Rating</h4>
                  ...
                  <h4 className="text-sm font-medium text-gray-700 mb-2">Identified Conditions</h4>
                  <div className="divide-y divide-gray-200">
                    {documentEstimates.map((estimate) => (
                      <div key={estimate.id} className="py-3 flex justify-between items-center">
                        <span className="text-sm text-gray-800">{estimate.condition}</span>
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-md p-4 flex items-start">
                  ...
                  <div>
                    <p className="text-amber-700 text-sm font-medium">Processing Document</p>
                    <p className="text-amber-600 text-xs mt-1">
                      This document is still being analyzed. Results will appear here when ready.
                    </p>
                  </div>
                </div>
              )}
