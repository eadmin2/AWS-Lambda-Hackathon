...
const CookieConsentBanner: React.FC = () => {
  ...
  const [customizePrefs, setCustomizePrefs] =
    useState<CookiePreferences>(defaultPrefs);
  useEffect(() => {
    if (showCustomize) {
      ...
      >
        <div className="flex-1">
          ...
          <p className="text-gray-700 text-sm md:text-base">
            ...
            assist in our marketing efforts. You can accept all cookies, reject
            non-essential cookies, or customize your preferences. See our{" "}
            <Link
              to="/privacy"
              ...
              <div className="space-y-5 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Required for the website to function and cannot be
                      switched off.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Remember your settings and preferences to personalize your
                      experience.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Used to show you relevant ads and measure their
                      effectiveness.
                    </p>
                  </div>
                </div>
