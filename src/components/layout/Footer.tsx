      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-600">
              Helping veterans navigate their disability claims with AI-powered document analysis.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <a href="https://www.va.gov/disability/about-disability-ratings/" target="_blank" rel="noopener noreferrer" className="text-base text-gray-600 hover:text-gray-900">
                  VA Rating Guide
                </a>
              </li>
              <li>
                <a href="https://www.va.gov/find-forms/about-form-21-4138/" target="_blank" rel="noopener noreferrer" className="text-base text-gray-600 hover:text-gray-900">
                  VA Forms
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link to="/disclaimer" className="text-base text-gray-600 hover:text-gray-900">
                  Medical Disclaimer
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
          <div className="flex space-x-6 md:order-2">
            ...
            <Link to="/disclaimer" className="text-gray-500 hover:text-gray-600">
              <span className="text-sm">Disclaimer</span>
            </Link>
          </div>
          <p className="mt-8 text-sm text-gray-500 md:mt-0 md:order-1">
            &copy; {new Date().getFullYear()} VA Rating Assistant. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
