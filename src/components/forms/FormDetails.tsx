import { X, Download, Calendar, FileText, Building, Tag } from 'lucide-react';
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <dl className="space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <dd className="text-sm font-medium text-gray-900">{form.attributes.language.toUpperCase()}</dd>
                </div>
                <div className="flex justify-between">
